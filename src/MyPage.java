...
HighSec obj=new HighSec();
    ...
    private void initComponents() {
            ...
            .addGroup(ViewbalTabLayout.createSequentialGroup()
                ...
                .addGroup(ViewbalTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(ViewbalTabLayout.createSequentialGroup()
                        ...
                        .addGap(149, 149, 149)
                        .addGroup(ViewbalTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(FullnameVB, javax.swing.GroupLayout.DEFAULT_SIZE, 333, Short.MAX_VALUE)
        ...
        Authorstxt.setText("Team: YoxYonko and other");
...
//save profile details
    private void SaveProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveProfileActionPerformed
        ...
        try{
            ...
            String sql = "UPDATE Account2 SET Gender='"+value1+"',Ethnicity='"+value2+"',Address='"+value3+"',Mob='"+value4+"',Sec_Q='"+value5+"' where Name='"+value6+"'";
            pst = conn.prepareStatement(sql);
            pst.execute();

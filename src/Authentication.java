...
int counter=0;
List<String>blocker=new ArrayList<String>();
    /**
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(445, 412));
...
// authenticate user details with database
    private void LogonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogonActionPerformed
        ...
        try{
            if(blocker.indexOf(AccnumLP.getText())==-1){
                ...
                if(rs.next()){
                    ...
                    counter++;
                    if(counter>=3){
                        blocker.add(AccnumLP.getText());
                        counter=0;
                    }
                    JOptionPane.showMessageDialog(null,"Incorrect login"+counter);
                }
            }else{
                JOptionPane.showMessageDialog(null, "Your Account has blocked,Please Contact Admin");
            }

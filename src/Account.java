...
PreparedStatement pst;
    ...
    public void Acc2(){
            String sql2 = "insert into Account2(Acc,Name,DOB,Pin,Acc_Type,Ethnicity,MICR_No,Gender,Mob,Address,Sec_Q,Sec_A,Balance) values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
            try{
...
//Create a bank account
    private void CreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreateActionPerformed
        ...
        /*String re="[a-zA-Z_0-9]";
            ...
            Matcher mt=pt.matcher(AddressAP.getName());
         if(!mt.matches()){
            JOptionPane.showMessageDialog(null,"Please Input Valid Characters in Address feild");
            //return ;
        ...
        try{
            pst = conn.prepareStatement(sql);
            pst.setString(1, AccnumAP.getText());
            pst.setString(2, Encypt.getMd5(FullnameAP.getText()));
            pst.setString(3, Encypt.getMd5(((JTextField)DateofbirthAP.getDateEditor().getUiComponent()).getText()));
            pst.setString(4, Encypt.getMd5(PinAP.getText()));
            pst.setString(5, Encypt.getMd5((String) AcctypeAP.getSelectedItem()));
            pst.setString(6, Encypt.getMd5((String) EthnicityAP.getSelectedItem()));
            pst.setString(7, Encypt.getMd5(MnumAP.getText()));// 4942   823
            
            Male.setActionCommand("Male");
            Female.setActionCommand("Female");
            Other.setActionCommand("Other");
            pst.setString(8, buttonGroup1.getSelection().getActionCommand());
            pst.setString(9, Encypt.getMd5(MobileAP.getText()));
            pst.setString(10, Encypt.getMd5(AddressAP.getText()));
